...
# The command to run this script: `brownie run scripts/deploy/mainnet_fork_proxy_admin.py  --network=iotex-mainnet-fork`
...
def main():
    ...
    # Load accounts
    owner = accounts.at("0xbFdDf5e269C74157b157c7DaC5E416d44afB790d", True)
