...
# The command to run this script: `brownie run scripts/authorize/mainnet_fork_proxy_admin.py  --network=iotex-mainnet-fork`
...
def main():
    ...
    # Personal accounts
    personal_deployer = accounts.at("0x3af43AfEd31C00311381A8DF26cc58C9bD2b5375", True)
    personal_owner = accounts.at("0xbFdDf5e269C74157b157c7DaC5E416d44afB790d", True)
