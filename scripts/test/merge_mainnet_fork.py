...
# The command to run this script: `brownie run scripts/test/merge_mainnet_fork.py  --network=iotex-mainnet-fork`
...
def main():
    ...
    # Account
    staker2 = accounts.at("0xC8a85eD8A9aBF0a21031B7c62C13464D1527cd09", True)

    # Fund
    fund_base = 1e18
    accounts[0].transfer(staker2, fund_base * 10000000)
