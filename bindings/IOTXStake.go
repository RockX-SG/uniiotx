...
//
// Solidity: function getStakedTokenCount(uint256 level) view returns(uint256 count)
func (_IOTXStake *IOTXStakeCaller) GetStakedTokenCount(opts *bind.CallOpts, level *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _IOTXStake.contract.Call(opts, &out, "getStakedTokenCount", level)
...
//
// Solidity: function getStakedTokenCount(uint256 level) view returns(uint256 count)
func (_IOTXStake *IOTXStakeSession) GetStakedTokenCount(level *big.Int) (*big.Int, error) {
	return _IOTXStake.Contract.GetStakedTokenCount(&_IOTXStake.CallOpts, level)
}

// GetStakedTokenCount is a free data retrieval call binding the contract method 0x2291f70a.
//
// Solidity: function getStakedTokenCount(uint256 level) view returns(uint256 count)
func (_IOTXStake *IOTXStakeCallerSession) GetStakedTokenCount(level *big.Int) (*big.Int, error) {
	return _IOTXStake.Contract.GetStakedTokenCount(&_IOTXStake.CallOpts, level)
}
