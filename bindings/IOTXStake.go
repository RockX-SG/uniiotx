...
//
// Solidity: function getStakedTokenCount(uint256 stakingLevel) view returns(uint256 count)
func (_IOTXStake *IOTXStakeCaller) GetStakedTokenCount(opts *bind.CallOpts, stakingLevel *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _IOTXStake.contract.Call(opts, &out, "getStakedTokenCount", stakingLevel)
...
//
// Solidity: function getStakedTokenCount(uint256 stakingLevel) view returns(uint256 count)
func (_IOTXStake *IOTXStakeSession) GetStakedTokenCount(stakingLevel *big.Int) (*big.Int, error) {
	return _IOTXStake.Contract.GetStakedTokenCount(&_IOTXStake.CallOpts, stakingLevel)
}

// GetStakedTokenCount is a free data retrieval call binding the contract method 0x2291f70a.
//
// Solidity: function getStakedTokenCount(uint256 stakingLevel) view returns(uint256 count)
func (_IOTXStake *IOTXStakeCallerSession) GetStakedTokenCount(stakingLevel *big.Int) (*big.Int, error) {
	return _IOTXStake.Contract.GetStakedTokenCount(&_IOTXStake.CallOpts, stakingLevel)
}
