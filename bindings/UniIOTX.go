...
func (_UniIOTX *UniIOTXTransactor) BatchTransfer(opts *bind.TransactOpts, recipients []common.Address, amounts []*big.Int) (*types.Transaction, error) {
	return _UniIOTX.contract.Transact(opts, "batchTransfer", recipients, amounts)
}

// BatchTransfer is a paid mutator transaction binding the contract method 0x88d695b2.
//
// Solidity: function batchTransfer(address[] recipients, uint256[] amounts) returns()
func (_UniIOTX *UniIOTXSession) BatchTransfer(recipients []common.Address, amounts []*big.Int) (*types.Transaction, error) {
	return _UniIOTX.Contract.BatchTransfer(&_UniIOTX.TransactOpts, recipients, amounts)
}

// BatchTransfer is a paid mutator transaction binding the contract method 0x88d695b2.
//
// Solidity: function batchTransfer(address[] recipients, uint256[] amounts) returns()
func (_UniIOTX *UniIOTXTransactorSession) BatchTransfer(recipients []common.Address, amounts []*big.Int) (*types.Transaction, error) {
	return _UniIOTX.Contract.BatchTransfer(&_UniIOTX.TransactOpts, recipients, amounts)
}
...
//
// Solidity: function initialize(address iotxStaker) returns()
func (_UniIOTX *UniIOTXTransactor) Initialize(opts *bind.TransactOpts, iotxStaker common.Address) (*types.Transaction, error) {
	return _UniIOTX.contract.Transact(opts, "initialize", iotxStaker)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address iotxStaker) returns()
func (_UniIOTX *UniIOTXSession) Initialize(iotxStaker common.Address) (*types.Transaction, error) {
	return _UniIOTX.Contract.Initialize(&_UniIOTX.TransactOpts, iotxStaker)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address iotxStaker) returns()
func (_UniIOTX *UniIOTXTransactorSession) Initialize(iotxStaker common.Address) (*types.Transaction, error) {
	return _UniIOTX.Contract.Initialize(&_UniIOTX.TransactOpts, iotxStaker)
}
...
func (_UniIOTX *UniIOTXTransactor) Mint(opts *bind.TransactOpts, account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _UniIOTX.contract.Transact(opts, "mint", account, amount)
}

// Mint is a paid mutator transaction binding the contract method 0x40c10f19.
//
// Solidity: function mint(address account, uint256 amount) returns()
func (_UniIOTX *UniIOTXSession) Mint(account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _UniIOTX.Contract.Mint(&_UniIOTX.TransactOpts, account, amount)
}

// Mint is a paid mutator transaction binding the contract method 0x40c10f19.
//
// Solidity: function mint(address account, uint256 amount) returns()
func (_UniIOTX *UniIOTXTransactorSession) Mint(account common.Address, amount *big.Int) (*types.Transaction, error) {
	return _UniIOTX.Contract.Mint(&_UniIOTX.TransactOpts, account, amount)
}
