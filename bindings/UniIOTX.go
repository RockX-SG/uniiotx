...
//
// Solidity: function initialize(address iotxStakeAddress) returns()
func (_UniIOTX *UniIOTXTransactor) Initialize(opts *bind.TransactOpts, iotxStakeAddress common.Address) (*types.Transaction, error) {
	return _UniIOTX.contract.Transact(opts, "initialize", iotxStakeAddress)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address iotxStakeAddress) returns()
func (_UniIOTX *UniIOTXSession) Initialize(iotxStakeAddress common.Address) (*types.Transaction, error) {
	return _UniIOTX.Contract.Initialize(&_UniIOTX.TransactOpts, iotxStakeAddress)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address iotxStakeAddress) returns()
func (_UniIOTX *UniIOTXTransactorSession) Initialize(iotxStakeAddress common.Address) (*types.Transaction, error) {
	return _UniIOTX.Contract.Initialize(&_UniIOTX.TransactOpts, iotxStakeAddress)
}
