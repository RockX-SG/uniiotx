...
contract IOTXClear is IIOTXClear, Initializable, PausableUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function name() external pure returns (string memory) { return "RockX Claimable IOTEX"; }
    function symbol() external pure returns (string memory) { return "redeemIOTEX"; }
